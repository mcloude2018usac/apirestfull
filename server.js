...
io.on('connection', (socket) =>
{
 ...
 socket.on('add-message', (message) => {
  console.log(message)
   io.emit('message', {text: message.text, messageimg  	: message.imagen,text2: message.text2,imagen2:message.imagen2, from: socket.nickname, created: new Date()});   
