...
var cadii="INSERT INTO [dbo].[Declaraciones]([anyo],[agente_pat],[agente_pol],[clase_dec],[cod_regimen],[adu_ent_sale_cod_sat],[deposito_zona_franca_cod],[peso_bruto_total],[peso_neto_total],[nit_interesado],[nombre_interesado],[DIR1_INTERESADO],[total_fob_usd],[total_flete_usd],[total_seguro_usd],[total_otros_usd],[total_cif_usd],[selectivo],[r_selectivo],[total_bultos],[pagos_autoliquidado],[numero_dua],[equipo_numero],[adu_des_cod_sat],[FECHACREACION])VALUES "+
+ "('" + ejecuta1.datat[0].anyo +"'," + "'" + ejecuta1.datat[0].agente_pat +"',"+ "" + ejecuta1.datat[0]. agente_pol + ","+ "'" + ejecuta1.datat[0].clase_dec+"',"
