                                                ...
                                                for(var i = 0; i < todos.length;i++){//todos los permisos
                                                        for(var j = 0; j < todos2.length;j++){//todos los modulos
                                                                ...
                                                                {   
                                                                                ...
                                                                                if(todos4[k].idpermiso==todos[i]._id )
                                                                                {
                                                                                                                ...
                                                                                                                for(var j5a = 0; j5a < todos2.length;j5a++){
                                                                                                                        ...
                                                                                                                        {   aa=1;
                                                                                                                                ...
                                                                                                                                childrem2.push({nivel:todos2[j5a].nivel,idrol:todos4[k].idrol,title:todos2[j5a].nombre,component: todos2[j5a].componente,
                                                                                                                                                tabComponent:todos2[j5a].tabcomponente, grupo:todos2[j5a].grupo,
                                                                                        ...
                                                                                        for(var j5 = 0; j5 < todos2.length;j5++){
                                                                                                ...
                                                                                                { 
                                                                                                        if(aa==1)
                                                                                                        {
                                                                                                                childrem.push({nivel:todos2[j5].nivel,idrol:todos4[k].idrol,title:todos2[j5].nombre,component: todos2[j5].componente, tabComponent:todos2[j5].tabcomponente,grupo:todos2[j5].grupo,name:todos2[j5].componente,index:todos2[j5].index,icon:todos2[j5].icono,estado:todos2[j5].estado,
                                                                        ...
                                                                        myData.push({nivel:todos2[j].nivel, idrol:todos[i].idrol,title:todos2[j].nombre,component: todos2[j].componente, tabComponent:todos2[j].tabcomponente,grupo:todos2[j].grupo,name:todos2[j].componente,index:todos2[j].index,icon:todos2[j].icono,estado:todos2[j].estado,
