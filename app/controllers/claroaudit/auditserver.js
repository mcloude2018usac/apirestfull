...
exports.getAuditserver = function(req, res, next){
            ...
            Auditserver.find({idempresa:req.params.id}).populate('marca').populate('modelo').populate('pais').populate('nodo').exec(function(err, todos) {
                if (err){  res.send(err);  }
                 res.json(todos);
             });
    ...
    { 
        ...
        Auditserver.findById({ _id: req.params.id}, function (err, todo)  {
            ...
            {  todo.nombre       	=	req.body.nombre        	||	todo.nombre        	;         
               ...
               todo.tipoconexion      	=	req.body.tipoconexion        	||	todo.tipoconexion        	;          
