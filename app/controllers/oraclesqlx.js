...
break;
case 'ind1det':
qry=" select TM.id_indicador, PARTICIPACION.id_producto,(select PRODUCTO.nombre from PRODUCTO where PRODUCTO.id_producto = PARTICIPACION.id_producto) producto, 'Q.' ||to_char(TM.monto_inicial, 'FM999,999,999.00') monto_inicial, 'Q.' ||to_char(TM.monto_vigente, 'FM999,999,999.00') monto_vigente , 'Q.' ||to_char(TM.monto_ejecutado, 'FM999,999,999.00') monto_ejecutado,  round((case when TM.monto_vigente=0 THEN 0 ELSE (TM.monto_ejecutado/TM.monto_vigente)*100 END),0) monto_porc,to_char(TM.cant_inicial, '999,999,999') cant_inicial, to_char(TM.cant_vigente, '999,999,999') cant_vigente, to_char(TM.cant_ejecutado, '999,999,999') cant_ejecutado ,  round((case when TM.cant_vigente=0 THEN 0 ELSE ( TM.cant_ejecutado/TM.cant_vigente)*100 END),0) cantidad_porc,  DEPENDENCIA_GOBIERNO.siglas, TIPO_PARTICIPACION.nombre participacion from PARTICIPACION, DEPENDENCIA_GOBIERNO, TIPO_PARTICIPACION, INDICADOR_X_PRODUCTO, ( select T.id_indicador, T.id_producto, sum(T.M_inicial) monto_inicial, sum(T.M_vigente) monto_vigente, sum(T.M_ejecutado) monto_ejecutado, sum(T.C_inicial) cant_inicial, sum(T.C_vigente) cant_vigente, sum(T.C_ejecutado) cant_ejecutado  from ( select INDICADOR_X_PRODUCTO.id_indicador,       PRODUCTO.id_producto,        DS1.fecha,        DS1.valor M_inicial, 0 M_ejecutado, 0 M_vigente,       0 C_inicial, 0 C_ejecutado, 0 C_vigente from DATO_SERIE_EJEC DS1, SERIE_EJECUCION, PRODUCTO, INDICADOR_X_PRODUCTO where INDICADOR_X_PRODUCTO.id_indicador = " + req.params.id2 + " and INDICADOR_X_PRODUCTO.id_producto = PRODUCTO.id_producto and PRODUCTO.id_producto = SERIE_EJECUCION.id_producto  and DS1.id_serie_ejec = SERIE_EJECUCION.id_serie_ejec and fecha = TO_DATE('31/12/2019','DD/MM/YYYY') /* EN EL FUTURO SERA UN PARAMETRO */ and SERIE_EJECUCION.id_tipo_serie_ejec = 2 and SERIE_EJECUCION.id_concepto_ejec = 2  union select INDICADOR_X_PRODUCTO.id_indicador,       PRODUCTO.id_producto,        DS1.fecha,        0 M_inicial, DS1.valor M_ejecutado, 0 M_vigente,       0 C_inicial, 0 C_ejecutado, 0 C_vigente from DATO_SERIE_EJEC DS1, SERIE_EJECUCION, PRODUCTO, INDICADOR_X_PRODUCTO where INDICADOR_X_PRODUCTO.id_indicador =  " + req.params.id2 + " and INDICADOR_X_PRODUCTO.id_producto = PRODUCTO.id_producto and PRODUCTO.id_producto = SERIE_EJECUCION.id_producto  and DS1.id_serie_ejec = SERIE_EJECUCION.id_serie_ejec and fecha = TO_DATE('31/12/2019','DD/MM/YYYY') /* EN EL FUTURO SERA UN PARAMETRO */ and SERIE_EJECUCION.id_tipo_serie_ejec = 3 and SERIE_EJECUCION.id_concepto_ejec = 2  union select INDICADOR_X_PRODUCTO.id_indicador,       PRODUCTO.id_producto,        DS1.fecha,        0 M_inicial, 0 M_ejecutado, DS1.valor M_vigente,       0 C_inicial, 0 C_ejecutado, 0 C_vigente from DATO_SERIE_EJEC DS1, SERIE_EJECUCION, PRODUCTO, INDICADOR_X_PRODUCTO where INDICADOR_X_PRODUCTO.id_indicador = " + req.params.id2 + " and INDICADOR_X_PRODUCTO.id_producto = PRODUCTO.id_producto and PRODUCTO.id_producto = SERIE_EJECUCION.id_producto  and DS1.id_serie_ejec = SERIE_EJECUCION.id_serie_ejec and fecha = TO_DATE('01/01/2019','DD/MM/YYYY') /* EN EL FUTURO SERA UN PARAMETRO */ and SERIE_EJECUCION.id_tipo_serie_ejec = 4 and SERIE_EJECUCION.id_concepto_ejec = 2  union select INDICADOR_X_PRODUCTO.id_indicador,       PRODUCTO.id_producto,        DS1.fecha,        0 M_inicial, 0 M_ejecutado, 0 M_vigente,       DS1.valor C_inicial, 0 C_ejecutado, 0 C_vigente from DATO_SERIE_EJEC DS1, SERIE_EJECUCION, PRODUCTO, INDICADOR_X_PRODUCTO where INDICADOR_X_PRODUCTO.id_indicador = " + req.params.id2 + " and INDICADOR_X_PRODUCTO.id_producto = PRODUCTO.id_producto and PRODUCTO.id_producto = SERIE_EJECUCION.id_producto  and DS1.id_serie_ejec = SERIE_EJECUCION.id_serie_ejec and fecha = TO_DATE('31/12/2019','DD/MM/YYYY') /* EN EL FUTURO SERA UN PARAMETRO */ and SERIE_EJECUCION.id_tipo_serie_ejec = 2 and SERIE_EJECUCION.id_concepto_ejec = 1   union select INDICADOR_X_PRODUCTO.id_indicador,       PRODUCTO.id_producto,        DS1.fecha,        0 M_inicial, 0 M_ejecutado, 0 M_vigente,       0 C_inicial, DS1.valor C_ejecutado, 0 C_vigente from DATO_SERIE_EJEC DS1, SERIE_EJECUCION, PRODUCTO, INDICADOR_X_PRODUCTO where INDICADOR_X_PRODUCTO.id_indicador = " + req.params.id2 + " and INDICADOR_X_PRODUCTO.id_producto = PRODUCTO.id_producto and PRODUCTO.id_producto = SERIE_EJECUCION.id_producto  and DS1.id_serie_ejec = SERIE_EJECUCION.id_serie_ejec and fecha = TO_DATE('31/12/2019','DD/MM/YYYY') /* EN EL FUTURO SERA UN PARAMETRO */ and SERIE_EJECUCION.id_tipo_serie_ejec = 3 and SERIE_EJECUCION.id_concepto_ejec = 1  union select INDICADOR_X_PRODUCTO.id_indicador,       PRODUCTO.id_producto,        DS1.fecha,        0 M_inicial, 0 M_ejecutado, 0 M_vigente,       0 C_inicial, 0 C_ejecutado, DS1.valor C_vigente from DATO_SERIE_EJEC DS1, SERIE_EJECUCION, PRODUCTO, INDICADOR_X_PRODUCTO where INDICADOR_X_PRODUCTO.id_indicador = " + req.params.id2 + " and INDICADOR_X_PRODUCTO.id_producto = PRODUCTO.id_producto and PRODUCTO.id_producto = SERIE_EJECUCION.id_producto  and DS1.id_serie_ejec = SERIE_EJECUCION.id_serie_ejec and fecha = TO_DATE('01/01/2019','DD/MM/YYYY') /* EN EL FUTURO SERA UN PARAMETRO */ and SERIE_EJECUCION.id_tipo_serie_ejec = 4 and SERIE_EJECUCION.id_concepto_ejec = 1  ) T group by id_indicador, id_producto order by id_indicador, id_producto ) TM where PARTICIPACION.id_producto = INDICADOR_X_PRODUCTO.id_producto and PARTICIPACION.id_dependencia_gob = DEPENDENCIA_GOBIERNO.id_dependencia_gob and TIPO_PARTICIPACION.id_tipo_participacion = PARTICIPACION.id_tipo_participacion and INDICADOR_X_PRODUCTO.id_indicador = " + req.params.id2 + " and PARTICIPACION.id_producto = TM.id_producto "
