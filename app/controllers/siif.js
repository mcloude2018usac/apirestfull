...
exports.getsiif = function(req, res, next){
    ...
    {  
        ...
        else
        {
            ...
            if(req.params.id2=='busca')
            {

                var myXMLText = '<?xml version="1.0" encoding="utf-8"?><Envelope xmlns="http://schemas.xmlsoap.org/soap/envelope/"><Body><getData xmlns="urn:miserviciowsdl"><carnet>9419254</carnet><id_ordenpago>11383045</id_ordenpago></getData></Body></Envelope>'
            ...
            {
            var myXMLText = '<?xml version="1.0" encoding="utf-8"?><Envelope xmlns="http://schemas.xmlsoap.org/soap/envelope/"><Body><getData xmlns="urn:miserviciowsdl"><carnet>9419254</carnet><unidad>29</unidad><extension>00</extension><carrera>00</carrera><nombre>benedicto16</nombre><monto>350</monto><anio>2020</anio><rubro>17</rubro><variante_rubro>1</variante_rubro><subtotal>350</subtotal></getData></Body></Envelope>'
