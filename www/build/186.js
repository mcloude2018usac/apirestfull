...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Unidadperiodo3CreatePage; });
...
var Unidadperiodo3CreatePage = /** @class */ (function () {
    function Unidadperiodo3CreatePage(storage, msj, translateService, viewCtrl, authService, navCtrl, navParams, _FB, actionSheetCtrl, events) {
        var _this = this;
    ...
    Unidadperiodo3CreatePage.prototype.ngOnInit = function () {
        var _this = this;
        this.storage.get('username').then(function (value) {
            _this.username = value;
        });
    };
    Unidadperiodo3CreatePage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    Unidadperiodo3CreatePage.prototype.manageGallery = function () {
        var _this = this;
        var creat = 'Actualiza';
        if (this.navParams.get("record") == null) {
            creat = 'Crea';
        ...
        if (this.navParams.get("record") == null) {
            if (options) {
                this.authService.createReg('', options, 'unidadperiodo3s').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
            ...
            if (options) {
                this.authService.createReg(this._ID, options, 'unidadperiodo3s').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
                    console.log(result);
    ...
    ], Unidadperiodo3CreatePage);
    return Unidadperiodo3CreatePage;
}());

//# sourceMappingURL=unidadperiodo3-create.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Unidadperiodo3CreatePageModule", function() { return Unidadperiodo3CreatePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__unidadperiodo3_create__ = __webpack_require__(1411);
...
var Unidadperiodo3CreatePageModule = /** @class */ (function () {
    function Unidadperiodo3CreatePageModule() {
    }
    Unidadperiodo3CreatePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__unidadperiodo3_create__["a" /* Unidadperiodo3CreatePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__unidadperiodo3_create__["a" /* Unidadperiodo3CreatePage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild()
            ],
        })
    ], Unidadperiodo3CreatePageModule);
    return Unidadperiodo3CreatePageModule;
}());

//# sourceMappingURL=unidadperiodo3-create.module.js.map
