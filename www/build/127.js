...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RepcarneCreatePageModule", function() { return RepcarneCreatePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__repcarne_create__ = __webpack_require__(1504);
...
var RepcarneCreatePageModule = /** @class */ (function () {
    function RepcarneCreatePageModule() {
    }
    RepcarneCreatePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__repcarne_create__["a" /* RepcarneCreatePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__repcarne_create__["a" /* RepcarneCreatePage */]),
                __WEBPACK_IMPORTED_MODULE_4__ngx_translate_core__["b" /* TranslateModule */].forChild(),
                __WEBPACK_IMPORTED_MODULE_3__pipes_pipes_module__["a" /* PipesModule */]
            ],
        })
    ], RepcarneCreatePageModule);
    return RepcarneCreatePageModule;
}());

//# sourceMappingURL=repcarne-create.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RepcarneCreatePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
...
var RepcarneCreatePage = /** @class */ (function () {
    function RepcarneCreatePage(storage, loadingCtrl, msj, translateService, viewCtrl, authService, navCtrl, navParams, _FB, actionSheetCtrl, events) {
        var _this = this;
    ...
    RepcarneCreatePage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    RepcarneCreatePage.prototype.ionViewDidLoad = function () {
        this.pageTitle = "Reposición de carné";
    ...
    RepcarneCreatePage.prototype.manageGallery = function () {
        var _this = this;
        var creat = 'Actualiza';
        if (this.navParams.get("record") == null) {
            creat = 'Crea';
        ...
        var options = {
            ...
            nombre: this.nombre,
            nota: 'Gracias por solicitar tu reposición de carné, en dos días hábiles te estaremos informando para que pases a recoger tu carnet.',
            estado: this.estado,
            bitacora: { idempresa: this.idempresa, idafiliado: '', email: this.username, permiso: creat, accion: creat + ' reverion ' }
        };
        if (this.navParams.get("record") == null) {
            if (options) {
                this.authService.createReg('', options, 'repcarnes').then(function (result) {
            ...
            if (options) {
                this.authService.createReg(this._ID, options, 'repcarnes').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
                    _this.viewCtrl.dismiss(result);
    ...
    RepcarneCreatePage.prototype.cancel = function () {
        this.viewCtrl.dismiss();
    };
    RepcarneCreatePage.prototype.done = function () {
        if (!this.form.valid) {
            return;
        }
        //this.viewCtrl.dismiss(this.form.value);
    };
    RepcarneCreatePage.prototype.focused = function (selectedValue) {
        var _this = this;
    ...
    return RepcarneCreatePage;
}());

//# sourceMappingURL=repcarne-create.js.map
