...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DashboardParqueoPage; });
...
var DashboardParqueoPage = /** @class */ (function () {
    function DashboardParqueoPage(storage, alertCtrl, msj, translateService, navCtrl, _FB, navParams, regService) {
    ...
    DashboardParqueoPage.prototype.clearSearchg = function () {
        this.gSearchQuery = '';
    };
    DashboardParqueoPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.storage.get('tiposus').then(function (value) {
            _this.tiposus = value.split(',');
            _this.idsuscriptor = _this.tiposus[3];
            _this.idempresa0 = _this.tiposus[8];
            _this.regService.getReg(_this.idempresa0, 'afiliados').then(function (result) {
    ...
    DashboardParqueoPage.prototype.ngOnInit = function () {
        var _this = this;
        this.storage.get('username').then(function (value) {
            _this.username = value;
        });
    };
    DashboardParqueoPage.prototype.defineChartData = function () {
        var k;
    ...
    DashboardParqueoPage.prototype.showFilter = function () {
    };
    DashboardParqueoPage.prototype.twoDecimals = function (number) {
        return 0;
    };
    DashboardParqueoPage.prototype.loadMore = function (ev) {
        this.gLimit += 50;
        setTimeout(function () { return ev.complete(); }, 1000);
    };
    DashboardParqueoPage.prototype.manageGallery = function () {
        var _this = this;
    ...
    DashboardParqueoPage.prototype.createPieChart = function () {
     ...
     *
     */
    DashboardParqueoPage.prototype.createBarChart = function () {
     ...
     *
     */
    DashboardParqueoPage.prototype.createLineChart = function () {
    ...
    DashboardParqueoPage.prototype.createghnutChart = function () {
    ...
    DashboardParqueoPage.prototype.presentFilter = function () {
    };
    DashboardParqueoPage.prototype.onSelectChange = function (selectedValue) {
        var _this = this;
        this.idtarifa2 = selectedValue.split(',');
        this.regService.getReg(this.idempresa0 + '/' + this.idtarifa2[0], 'buss').then(function (result) {
            _this.vruta = result;
    ...
    ], DashboardParqueoPage);
    return DashboardParqueoPage;
}());

//# sourceMappingURL=dashboard-parqueo.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DashboardParqueoPageModule", function() { return DashboardParqueoPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dashboard_parqueo__ = __webpack_require__(1352);
...
var DashboardParqueoPageModule = /** @class */ (function () {
    function DashboardParqueoPageModule() {
    }
    DashboardParqueoPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__dashboard_parqueo__["a" /* DashboardParqueoPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__dashboard_parqueo__["a" /* DashboardParqueoPage */]),
                __WEBPACK_IMPORTED_MODULE_4__ngx_translate_core__["b" /* TranslateModule */].forChild(),
                __WEBPACK_IMPORTED_MODULE_3__pipes_pipes_module__["a" /* PipesModule */]
            ],
        })
    ], DashboardParqueoPageModule);
    return DashboardParqueoPageModule;
}());

//# sourceMappingURL=dashboard-parqueo.module.js.map
