...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmpresaCreatePageModule", function() { return EmpresaCreatePageModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__empresa_create__ = __webpack_require__(1457);
...
var EmpresaCreatePageModule = /** @class */ (function () {
    function EmpresaCreatePageModule() {
    }
    EmpresaCreatePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__empresa_create__["a" /* EmpresaCreatePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__empresa_create__["a" /* EmpresaCreatePage */]),
                __WEBPACK_IMPORTED_MODULE_2__ngx_translate_core__["b" /* TranslateModule */].forChild()
            ],
        })
    ], EmpresaCreatePageModule);
    return EmpresaCreatePageModule;
}());

//# sourceMappingURL=empresa-create.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmpresaCreatePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
...
var EmpresaCreatePage = /** @class */ (function () {
    function EmpresaCreatePage(storage, msj, translateService, viewCtrl, authService, navCtrl, navParams, _FB, actionSheetCtrl, events) {
        var _this = this;
    ...
    EmpresaCreatePage.prototype.ngOnInit = function () {
        var _this = this;
        this.storage.get('username').then(function (value) {
            _this.username = value;
        });
    };
    EmpresaCreatePage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    EmpresaCreatePage.prototype.manageGallery = function () {
        var _this = this;
        var creat = 'Actualiza';
        if (this.navParams.get("record") == null) {
            creat = 'Crea';
        ...
        if (this.navParams.get("record") == null) {
            if (options) {
                this.authService.createReg('', options, 'empresas').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
            ...
            if (options) {
                this.authService.createReg(this._ID, options, 'empresas').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
                    _this.viewCtrl.dismiss(result);
    ...
    EmpresaCreatePage.prototype.cancel = function () {
        this.viewCtrl.dismiss();
    };
    EmpresaCreatePage.prototype.done = function () {
        if (!this.form.valid) {
            return;
        }
    ...
    return EmpresaCreatePage;
}());

//# sourceMappingURL=empresa-create.js.map
