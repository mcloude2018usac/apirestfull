...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ParticipaCreatePageModule", function() { return ParticipaCreatePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__participa_create__ = __webpack_require__(1472);
...
var ParticipaCreatePageModule = /** @class */ (function () {
    function ParticipaCreatePageModule() {
    }
    ParticipaCreatePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__participa_create__["a" /* ParticipaCreatePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__participa_create__["a" /* ParticipaCreatePage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild(),
                __WEBPACK_IMPORTED_MODULE_4_ngx_qrcode2__["a" /* NgxQRCodeModule */]
            ],
        })
    ], ParticipaCreatePageModule);
    return ParticipaCreatePageModule;
}());

//# sourceMappingURL=participa-create.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ParticipaCreatePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
...
var ParticipaCreatePage = /** @class */ (function () {
    function ParticipaCreatePage(storage, msj, translateService, viewCtrl, authService, navCtrl, navParams, _FB, actionSheetCtrl, events) {
        var _this = this;
    ...
    ParticipaCreatePage.prototype.ngOnInit = function () {
        var _this = this;
        this.storage.get('username').then(function (value) {
            _this.username = value;
        });
    };
    ParticipaCreatePage.prototype.ionViewDidLoad = function () {
        var _this = this;
        ...
        if (this.navParams.get("record") == null) {
            ...
            this.genero = this.navParams.data.record.genero;
            this.edad = this.navParams.data.record.edad;
            ...
            this.otros = this.navParams.data.record.otros;
    ...
    ParticipaCreatePage.prototype.manageGallery = function () {
        var _this = this;
        var estadot = 'Ingreso';
        var creat = 'Actualiza';
        if (this.navParams.get("record") == null) {
            ...
            estadot = this.form.controls['estado'].value;
        }
        this.form.controls['edad'].setValue('0');
        this.form.controls['genero'].setValue('0');
        this.form.controls['telefono'].setValue('0');
        this.form.controls['unidad'].setValue('0');
        this.form.controls['otros'].setValue('2.Conferencia Auditoria Publica');
        this.form.controls['estado'].setValue('Ingreso');
        var options = {
        ...
        if (this.navParams.get("record") == null) {
            if (options) {
                this.authService.createReg('', options, 'participas').then(function (result) {
                    //this.form.controls['nombre'].setValue('');
                    // this.form.controls['apellido'].setValue('');
                    //      this.msj.showError3('Exito','Registros creado con éxito , Por favor ingrese al evento .');
                    // this.form.controls['nombre'].setFocus();
                    if (!_this.form.valid) {
                        return;
                    }
            ...
            if (options) {
                this.authService.createReg(this._ID, options, 'participas').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
                    _this.viewCtrl.dismiss(result);
    ...
    return ParticipaCreatePage;
}());

//# sourceMappingURL=participa-create.js.map
