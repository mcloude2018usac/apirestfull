...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ConvenioCalusacd2CreatePage; });
...
var ConvenioCalusacd2CreatePage = /** @class */ (function () {
    function ConvenioCalusacd2CreatePage(storage, msj, translateService, viewCtrl, authService, navCtrl, navParams, _FB, actionSheetCtrl, events) {
        var _this = this;
    ...
    ConvenioCalusacd2CreatePage.prototype.ngOnInit = function () {
        var _this = this;
        this.storage.get('username').then(function (value) {
            _this.username = value;
        });
    };
    ConvenioCalusacd2CreatePage.prototype.onSelectChange2 = function (selectedValue) {
        var _this = this;
        ...
        if (this.tipounidad == '') { }
            ...
            this.authService.getReg2b(this.idtipounidad2[0] + '/' + this.idunidadacademica2[0] + '/todosver', 'unidadperiodo3s').then(function (result) {
                if (result) {
    ...
    ConvenioCalusacd2CreatePage.prototype.onSelectChange4 = function (selectedValue) {
        var _this = this;
        this.idjornada2 = selectedValue.split(',');
        this.vpago = [];
        this.idpago2 = [];
        this.authService.getReg2b(this.idtipounidad2[0] + '/' + this.idunidadacademica2[0] + '/' + this.idperiodo2[0] + '/' + this.tipo + '/' + this.idjornada2[0] + '/1', 'unidadplan3s').then(function (result) {
            _this.vpago = result;
        }, function (err) {
            _this.msj.showError3('Error', err.error);
        });
    };
    ConvenioCalusacd2CreatePage.prototype.onSelectChange3a = function (selectedValue) {
        var _this = this;
        this.idperiodo2 = selectedValue.split(',');
        this.ano = this.idperiodo2[2];
        this.authService.getReg2b(this.idtipounidad2[0] + '/' + this.idunidadacademica2[0] + '/' + this.idperiodo2[0] + '/1' + '/jornadas2a', 'unidadplan3s').then(function (result) {
            _this.vjornada = result;
        }, function (err) {
            _this.msj.showError3('Error', err.error);
        });
    };
    ConvenioCalusacd2CreatePage.prototype.onSelectChange3 = function (selectedValue) {
        var _this = this;
        ...
        this.authService.getReg2b(this.idtipounidad2[0] + '/' + this.idunidadacademica2[0] + '/' + this.idperiodo2[0] + '/' + this.idjornada2[0] + '°' + this.nivel + '/horarios2a', 'unidadplan3s').then(function (result) {
    ...
    ConvenioCalusacd2CreatePage.prototype.onSelectChange = function (selectedValue) {
        var _this = this;
        ...
        if (this.idtipounidad2[2] == 'Inactivo') {
            ...
            if (this.tipounidad == '') { }
                ...
                this.authService.getReg2b(this.idtipounidad2[0] + '/2/' + this.tipo, 'unidadacademica3s').then(function (result) {
    ...
    ConvenioCalusacd2CreatePage.prototype.onSelectChange5 = function (selectedValue) {
        var _this = this;
        this.idhorario2 = selectedValue.split(',');
        this.authService.getReg2b(this.idtipounidad2[0] + '/' + this.idunidadacademica2[0] + '/' + this.idperiodo2[0] + '/' + this.nivel + '°' + this.idhorario2[0] + '°' + this.idjornada2[0] + '/profesores2a', 'unidadplan3s').then(function (result) {
            _this.vprofesor = result;
        }, function (err) {
            _this.msj.showError3('Error', err.error);
        });
    };
    ConvenioCalusacd2CreatePage.prototype.onSelectChange7 = function (selectedValue) {
        this.idprofesor2 = selectedValue.split(',');
    };
    ConvenioCalusacd2CreatePage.prototype.ionViewDidLoad = function () {
        var _this = this;
        if (this.navParams.get("record") == null) {
            ...
            this.rubro = this.navParams.data.record.rubro;
            ...
            this.authService.getReg2b('todos', 'tipounidad3s').then(function (result) {
                ...
                _this.authService.getReg2b(_this.navParams.data.record.idtipounidad.id + '/2/' + _this.tipo, 'unidadacademica3s').then(function (result) {
                    _this.vgrupo2 = result;
    ...
    ConvenioCalusacd2CreatePage.prototype.manageGallery = function () {
        var _this = this;
        var creat = 'Actualiza';
        if (this.navParams.get("record") == null) {
            creat = 'Crea';
        ...
        var options = {
            ...
            comentario: this.form.controls['nombre'].value,
        ...
        if (this.navParams.get("record") == null) {
            if (options) {
                this.authService.createReg('', options, 'conveniocalusacd2s').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
            ...
            if (options) {
                this.authService.createReg(this._ID, options, 'conveniocalusacd2s').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
                    //   console.log(result)
    ...
    ], ConvenioCalusacd2CreatePage);
    return ConvenioCalusacd2CreatePage;
}());

//# sourceMappingURL=convenio-calusacd2-create.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConvenioCalusacd2CreatePageModule", function() { return ConvenioCalusacd2CreatePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__convenio_calusacd2_create__ = __webpack_require__(1363);
...
var ConvenioCalusacd2CreatePageModule = /** @class */ (function () {
    function ConvenioCalusacd2CreatePageModule() {
    }
    ConvenioCalusacd2CreatePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__convenio_calusacd2_create__["a" /* ConvenioCalusacd2CreatePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__convenio_calusacd2_create__["a" /* ConvenioCalusacd2CreatePage */]), __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild()
            ],
        })
    ], ConvenioCalusacd2CreatePageModule);
    return ConvenioCalusacd2CreatePageModule;
}());

//# sourceMappingURL=convenio-calusacd2-create.module.js.map
