...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Permiso2CreatePageModule", function() { return Permiso2CreatePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__permiso2_create__ = __webpack_require__(1557);
...
var Permiso2CreatePageModule = /** @class */ (function () {
    function Permiso2CreatePageModule() {
    }
    Permiso2CreatePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__permiso2_create__["a" /* Permiso2CreatePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__permiso2_create__["a" /* Permiso2CreatePage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild(),
                __WEBPACK_IMPORTED_MODULE_4_ionic_selectable__["b" /* IonicSelectableModule */]
            ],
        })
    ], Permiso2CreatePageModule);
    return Permiso2CreatePageModule;
}());

//# sourceMappingURL=permiso2-create.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Permiso2CreatePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
...
var Permiso2CreatePage = /** @class */ (function () {
    function Permiso2CreatePage(storage, msj, translateService, viewCtrl, authService, navCtrl, navParams, _FB, actionSheetCtrl, events) {
        var _this = this;
    ...
    Permiso2CreatePage.prototype.ngOnInit = function () {
        var _this = this;
        this.storage.get('username').then(function (value) {
            _this.username = value;
        });
    };
    Permiso2CreatePage.prototype.ionViewDidLoad = function () {
        var _this = this;
        ...
        if (this.navParams.get("record") == null) {
            ...
            this.authService.getReg(this.idempresa + '/' + this.idrol + '/' + this.idpermiso + '/orden', 'permiso2s').then(function (data) {
                if (data) {
                    var aa = data;
    ...
    Permiso2CreatePage.prototype.limpia = function (op) {
    ...
    Permiso2CreatePage.prototype.manageGallery = function () {
        var _this = this;
        var creat = 'Actualiza';
        if (this.navParams.get("record") == null) {
            creat = 'Crea';
        ...
        var options = {
            ...
            bitacora: { idempresa: this.idempresa, idafiliado: '', email: this.username, Permiso2: creat, accion: creat + ' Permiso2s ' }
        };
        if (this.navParams.get("record") == null) {
            if (options) {
                this.authService.createReg('', options, 'Permiso2s').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
            ...
            if (options) {
                this.authService.createReg(this._ID, options, 'Permiso2s').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
                    _this.viewCtrl.dismiss(result);
    ...
    Permiso2CreatePage.prototype.cancel = function () {
        this.viewCtrl.dismiss();
    };
    Permiso2CreatePage.prototype.done = function () {
        if (!this.form.valid) {
            return;
        }
        //this.viewCtrl.dismiss(this.form.value);
    };
    Permiso2CreatePage.prototype.portChange = function (event) {
    ...
    return Permiso2CreatePage;
}());

//# sourceMappingURL=permiso2-create.js.map
