...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Tipounidad3CreatePage; });
...
var Tipounidad3CreatePage = /** @class */ (function () {
    function Tipounidad3CreatePage(storage, msj, translateService, viewCtrl, authService, navCtrl, navParams, _FB, actionSheetCtrl, events) {
        var _this = this;
    ...
    Tipounidad3CreatePage.prototype.ngOnInit = function () {
        var _this = this;
        this.storage.get('username').then(function (value) {
            _this.username = value;
        });
    };
    Tipounidad3CreatePage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    Tipounidad3CreatePage.prototype.manageGallery = function () {
        var _this = this;
        var creat = 'Actualiza';
        if (this.navParams.get("record") == null) {
            creat = 'Crea';
        ...
        if (this.navParams.get("record") == null) {
            if (options) {
                this.authService.createReg('', options, 'tipounidad3s').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
            ...
            if (options) {
                this.authService.createReg(this._ID, options, 'tipounidad3s').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
                    //   console.log(result)
    ...
    ], Tipounidad3CreatePage);
    return Tipounidad3CreatePage;
}());

//# sourceMappingURL=tipounidad3-create.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Tipounidad3CreatePageModule", function() { return Tipounidad3CreatePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tipounidad3_create__ = __webpack_require__(1392);
...
var Tipounidad3CreatePageModule = /** @class */ (function () {
    function Tipounidad3CreatePageModule() {
    }
    Tipounidad3CreatePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__tipounidad3_create__["a" /* Tipounidad3CreatePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__tipounidad3_create__["a" /* Tipounidad3CreatePage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild()
            ],
        })
    ], Tipounidad3CreatePageModule);
    return Tipounidad3CreatePageModule;
}());

//# sourceMappingURL=tipounidad3-create.module.js.map
