...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Unidadperiodo4CreatePage; });
...
var Unidadperiodo4CreatePage = /** @class */ (function () {
    function Unidadperiodo4CreatePage(storage, msj, translateService, viewCtrl, authService, navCtrl, navParams, _FB, actionSheetCtrl, events) {
        var _this = this;
    ...
    Unidadperiodo4CreatePage.prototype.ngOnInit = function () {
        var _this = this;
        this.storage.get('username').then(function (value) {
            _this.username = value;
        });
    };
    Unidadperiodo4CreatePage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    Unidadperiodo4CreatePage.prototype.manageGallery = function () {
        var _this = this;
        var creat = 'Actualiza';
        if (this.navParams.get("record") == null) {
            creat = 'Crea';
        ...
        if (this.navParams.get("record") == null) {
            if (options) {
                this.authService.createReg('', options, 'unidadperiodo4s').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
            ...
            if (options) {
                this.authService.createReg(this._ID, options, 'unidadperiodo4s').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
                    console.log(result);
    ...
    ], Unidadperiodo4CreatePage);
    return Unidadperiodo4CreatePage;
}());

//# sourceMappingURL=unidadperiodo4-create.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Unidadperiodo4CreatePageModule", function() { return Unidadperiodo4CreatePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__unidadperiodo4_create__ = __webpack_require__(1366);
...
var Unidadperiodo4CreatePageModule = /** @class */ (function () {
    function Unidadperiodo4CreatePageModule() {
    }
    Unidadperiodo4CreatePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__unidadperiodo4_create__["a" /* Unidadperiodo4CreatePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__unidadperiodo4_create__["a" /* Unidadperiodo4CreatePage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild()
            ],
        })
    ], Unidadperiodo4CreatePageModule);
    return Unidadperiodo4CreatePageModule;
}());

//# sourceMappingURL=unidadperiodo4-create.module.js.map
