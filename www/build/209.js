...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CostocalusacCreatePage; });
...
var CostocalusacCreatePage = /** @class */ (function () {
    function CostocalusacCreatePage(storage, msj, translateService, viewCtrl, authService, navCtrl, navParams, _FB, actionSheetCtrl, events) {
        var _this = this;
    ...
    CostocalusacCreatePage.prototype.ngOnInit = function () {
        var _this = this;
        this.storage.get('username').then(function (value) {
            _this.username = value;
        });
    };
    CostocalusacCreatePage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    CostocalusacCreatePage.prototype.manageGallery = function () {
        var _this = this;
        var creat = 'Actualiza';
        if (this.navParams.get("record") == null) {
            creat = 'Crea';
        ...
        var options = {
            ...
            bitacora: { idempresa: this.idempresa, idafiliado: '', email: this.username, permiso: creat, accion: creat + ' costo servicios calusac ' }
        };
        if (this.navParams.get("record") == null) {
            if (options) {
                this.authService.createReg('', options, 'Costocalusacs').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
            ...
            if (options) {
                this.authService.createReg(this._ID, options, 'Costocalusacs').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
                    //   console.log(result)
    ...
    ], CostocalusacCreatePage);
    return CostocalusacCreatePage;
}());

//# sourceMappingURL=costocalusac-create.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CostocalusacCreatePageModule", function() { return CostocalusacCreatePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__costocalusac_create__ = __webpack_require__(1391);
...
var CostocalusacCreatePageModule = /** @class */ (function () {
    function CostocalusacCreatePageModule() {
    }
    CostocalusacCreatePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__costocalusac_create__["a" /* CostocalusacCreatePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__costocalusac_create__["a" /* CostocalusacCreatePage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild()
            ],
        })
    ], CostocalusacCreatePageModule);
    return CostocalusacCreatePageModule;
}());

//# sourceMappingURL=costocalusac-create.module.js.map
