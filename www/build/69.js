...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ResultadoovPageModule", function() { return ResultadoovPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__resultadoov__ = __webpack_require__(1574);
...
var ResultadoovPageModule = /** @class */ (function () {
    function ResultadoovPageModule() {
    }
    ResultadoovPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__resultadoov__["a" /* ResultadoovPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__resultadoov__["a" /* ResultadoovPage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild(),
                __WEBPACK_IMPORTED_MODULE_4__pipes_pipes_module__["a" /* PipesModule */]
            ],
        })
    ], ResultadoovPageModule);
    return ResultadoovPageModule;
}());

//# sourceMappingURL=resultadoov.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ResultadoovPage; });
...
*/
var ResultadoovPage = /** @class */ (function () {
    function ResultadoovPage(translateService, alertCtrl, msj, storage, regService, viewCtrl, Pdfx, navCtrl, navParams, _FB, actionSheetCtrl, events) {
        var _this = this;
    ...
    ResultadoovPage.prototype.loadMore = function (ev) {
        this.gLimit += 50;
        setTimeout(function () { return ev.complete(); }, 1000);
    };
    ResultadoovPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ResultadoovPage.prototype.goBack = function () {
        this.navCtrl.pop();
    };
    ResultadoovPage.prototype.ionViewDidLoad = function () {
    };
    ResultadoovPage.prototype.manageGallery2 = function () {
        this.Pdfx.daordenpago('123', 'si', []);
    };
    ResultadoovPage.prototype.manageGallery = function () {
        var _this = this;
        this.regService.getReglibreSext2(this.form.controls['nit'].value, 'estudianteov').then(function (data) {
            _this.items = data;
            _this.Pdfx.daov(_this.form.controls['nit'].value, 'si', data);
        }, function (err) {
            _this.msj.showError3('Resultado', 'Resultado no encontrado.');
        });
    };
    ResultadoovPage.prototype.cancel = function () {
        this.viewCtrl.dismiss();
    };
    ResultadoovPage.prototype.done = function () {
        if (!this.form.valid) {
            return;
        }
    ...
    return ResultadoovPage;
}());

//# sourceMappingURL=resultadoov.js.map
