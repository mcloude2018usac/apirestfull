...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DcatalogoCreatePageModule", function() { return DcatalogoCreatePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dcatalogo_create__ = __webpack_require__(1452);
...
var DcatalogoCreatePageModule = /** @class */ (function () {
    function DcatalogoCreatePageModule() {
    }
    DcatalogoCreatePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__dcatalogo_create__["a" /* DcatalogoCreatePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__dcatalogo_create__["a" /* DcatalogoCreatePage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild()
            ],
        })
    ], DcatalogoCreatePageModule);
    return DcatalogoCreatePageModule;
}());

//# sourceMappingURL=dcatalogo-create.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DcatalogoCreatePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
...
var DcatalogoCreatePage = /** @class */ (function () {
    function DcatalogoCreatePage(storage, _IMAGE, msj, translateService, viewCtrl, authService, navCtrl, navParams, _FB, actionSheetCtrl, events) {
        var _this = this;
    ...
    DcatalogoCreatePage.prototype.ngOnInit = function () {
        var _this = this;
        this.storage.get('username').then(function (value) {
            _this.username = value;
        });
    };
    DcatalogoCreatePage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.idcatalogo = this.navParams.data.record2.idcatalogo;
        this.nidcatalogo = this.navParams.data.record2.nidcatalogo;
    ...
    DcatalogoCreatePage.prototype.manageGallery = function () {
        var _this = this;
        var creat = 'Actualiza';
        if (this.navParams.get("record") == null) {
            creat = 'Crea';
        ...
        if (this.navParams.get("record") == null) {
            if (options) {
                this.authService.createReg('', options, 'dcatalogos').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
                    console.log(result);
            ...
            if (options) {
                this.authService.createReg(this._ID, options, 'dcatalogos').then(function (result) {
                    if (!_this.form.valid) {
                        return;
                    }
                    console.log(result);
    ...
    DcatalogoCreatePage.prototype.cancel = function () {
        this.viewCtrl.dismiss();
    };
    DcatalogoCreatePage.prototype.done = function () {
        if (!this.form.valid) {
            return;
        }
        //this.viewCtrl.dismiss(this.form.value);
    };
    DcatalogoCreatePage.prototype.updateProfileImage = function () {
        var _this = this;
        var t1, t2;
    ...
    DcatalogoCreatePage.prototype.takePhotograph = function () {
        var _this = this;
    ...
    DcatalogoCreatePage.prototype.selectImage = function () {
        var _this = this;
        if (__WEBPACK_IMPORTED_MODULE_6__ionic_native_camera__["a" /* Camera */]['installed']()) {
            this._IMAGE
                .selectPhotograph()
    ...
    DcatalogoCreatePage.prototype.processWebImage = function (event) {
        var _this = this;
    ...
    return DcatalogoCreatePage;
}());

//# sourceMappingURL=dcatalogo-create.js.map
